(function() {
  function Kkjjhlhlba() {
    if (window.kkjjhlhlba) {
      // This is a singleton. Don't create a new instance if new Kkjjhlhlba is called again.
      return window.kkjjhlhlba;
    }
    ...
    function createCheatSheet(shortcuts) {
      ...
      if (!container) {
        // exit early if we did not find the container
        return false;
      }
      for (var method in shortcuts) {
        if (shortcuts.hasOwnProperty(method)) {
          ...
          if (shortcut.description) {
            cheatsheet += '<li class="shortcut"><span class="method">' + method.split(',').join(', then ').replace('<', '&lt;').replace('>', '&gt;') + ':</span><span class="description">' + shortcut.description.replace('<', '&lt;').replace('>', '&gt;') + '<span></li>';
          }
        }
      }
    ...
    return {
      ...
      start: function(config) {
        ...
        if (!noCheatsheet && config.noCheatsheet) {
  ...
  window.kkjjhlhlba = new Kkjjhlhlba();
})();
